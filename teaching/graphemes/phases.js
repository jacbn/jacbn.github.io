...
const p5 = "ay ou ie ea oy ir eu aw ey wh ph ew oe au ould oup cc".split(' ');
const p3regexps_r = [/\by/g, /er\b/g];
const p5regexps = "a.e e.e i.e o.e u[^r]e q(?!u) (?<=a)ti(?=on|a) (?<=gr|l)ow(?!l) (?<=nd|sh|t)ow (?<=b)ow(?=l)".split(' ');
const p5regexps_r = [/er\B/g, /\By/g, /\buni/g, /[aeiou]c[aeiouy]/g, /\bcy/g, /(?<=\bs)ch/g, /\bch(?=r)/g, 
                     /\bch(?=em)/g, /(?<=te)ch/g, /(?<=\ba|[^eo]a)ch(?=e\b|es\b)/g, /mb\b/g];
